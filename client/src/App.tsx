...
const countries = [
  "Algeria", "Argentina", "Australia", "Brazil", "Canada", "China", "Egypt",
  "France", "Germany", "India", "Indonesia", "Italy", "Japan", "Jordan",
  "Lebanon", "Libya", "Malaysia", "Mauritania", "Mexico", "Morocco",
  "Netherlands", "Nigeria", "Pakistan", "Portugal", "Russia", "Saudi Arabia",
  "South Korea", "Spain", "Sudan", "Syria", "Tunisia", "Turkey", "UAE",
